...
<head>
	...
	<title>doan | Chi tiết sản phẩm</title>
...
EOT;
						...
						<div class="product__details__pic">
							...
							<div class="product__details__pic__item">
								<img class="product__details__pic__item--large"
									src="/doan/assets/uploads/products/<?=$hinhsanphamdautien['hsp_tentaptin'] ?>" alt="">
							</div>
							<div class="product__details__pic__slider owl-carousel">
								<?php foreach ($sanphamRow['danhsachhinhanh'] as $hinhsanpham) : ?>
								<div>
										<img data-imgbigurl="/doan/assets/uploads/products/<?= $hinhsanpham['hsp_tentaptin'] ?>"
											src="/doan/assets/uploads/products/<?= $hinhsanpham['hsp_tentaptin'] ?>" alt="">
								</div>
								<?php endforeach; ?>
							</div>
							...
							<div class="product__details__pic__item">
								<img class="product__details__pic__item--large tab-pane active" 
									src="/doan/assets/vendor/backend/img/default-image_600.png" alt="">
							</div>
							<div class="product__details__pic__slider owl-carousel">
								<div class="active">
										<img data-imgbigurl="/doan/assets/vendor/backend/img/default-image_600.png"
											src="/doan/assets/vendor/backend/img/default-image_600.png" alt="">
								</div>
							</div>
							<?php endif; ?>
	...
	<script>
		function addSanPhamVaoGioHang() {
			...
			$.ajax({
				url: '/doan/frontend/api/giohang-themsanpham.php',
				method: "POST",
				dataType: 'json',
				data: dulieugoi,
				success: function(data) {
					console.log(data);
					var htmlString =
						`Sản phẩm đã được thêm vào Giỏ hàng. <a href="/doan/frontend/sanpham/cart.php">Xem Giỏ hàng</a>.`;
