...
<style>
	...
	?>
		...
		<section class="breadcrumb-section set-bg" data-setbg="/doan/assets/vendor/frontend/img/breadcrumb.jpg">
		<div class="container">
			<div class="row">
			...
			<div class="row">
				<div class="col col-md-12">
									...
									<tr>
										...
										<td>
											<?php if (empty($sanpham['hinhdaidien'])) : ?>
												<img src="/doan/assets/vendor/frontend/img/default-image_600.png" class="img-fluid hinhdaidien" />
											<?php else : ?>
												<img src="/doan/assets/uploads/products/<?= $sanpham['hinhdaidien'] ?>" class="img-fluid hinhdaidien" />
											<?php endif; ?>
										</td>
					...
					<?php else : ?>
						<h2>Giỏ hàng rỗng!!!</h2>
					<?php endif; ?>
					<a href="/doan" class="btn btn-warning btn-md"><i class="fa fa-arrow-left" aria-hidden="true"></i> Quay
						về trang chủ</a>
					<a href="/doan/frontend/sanpham/checkout.php" class="btn btn-primary btn-md"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Thanh toán</a>
				</div>
			</div>
		</div>
	 ...
	 <script>
		$(document).ready(function() {
			function removeSanPhamVaoGioHang(id) {
				...
				$.ajax({
					url: '/doan/frontend/api/giohang-xoasanpham.php',
					method: "POST",
					dataType: 'json',
					data: dulieugoi,
			...
			function capnhatSanPhamTrongGioHang(id, soluong) {
				...
				$.ajax({
					url: '/doan/frontend/api/giohang-capnhatsanpham.php',
					method: "POST",
					dataType: 'json',
					data: dulieugoi,
					success: function(data) {
