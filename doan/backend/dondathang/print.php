...
<head>
	...
	<!-- Paper CSS -->
	<link rel="stylesheet" href="/doan/assets/vendor/backend/css/paper.min.css" type="text/css" />
...
EOT;
	...
	<section class="sheet padding-10mm">
		...
		<table border="0" width="100%" celthacing="0">
			<tbody>
				<tr>
					<td align="center"><img src="/doan/assets/vendor/backend/img/logo.png" width="200px" height="200px" /></td>
					<td align="center">
						<b style="font-size: 2em;">Doan - Vượt qua giới hạn</b><br />
