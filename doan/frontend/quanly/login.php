				...
				<form id="frmDangNhap" name="frmcreate" method="post" action="">
					<div class="row">
						<div class="col-lg-8 col-md-6">
							...
							<button type="submit" class="site-btn" name="btnDangNhap">Đăng Nhập</button>
							<a href="http://localhost:8088/doan/frontend/quanly/register.php" class="site-btn" name="btnDangNhap">Đăng Ký</a>
