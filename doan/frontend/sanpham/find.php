		...
		<div class="container">
			...
			<?php foreach ($dataDanhSachSanPham as $sanpham) : ?>
				<div class="col-lg-3 col-md-4 col-sm-6 ">
					...
					<a href="/doan/frontend/sanpham/detail.php?sp_id=<?= $sanpham['sp_id'] ?>">
						<div class="featured__item__pic set-bg" data-setbg="/doan/assets/uploads/products/<?= $sanpham['hsp_tentaptin'] ?>">
					<?php else : ?>
					<a href="/doan/frontend/sanpham/detail.php?sp_id=<?= $sanpham['sp_id'] ?>"> <div class="featured__item__pic set-bg" data-setbg="/doan/assets/vendor/backend/img/default-image_600.png">
					<?php endif; ?>
						</div>
					</a>
						<div class="featured__item__text">
							<h6><a href="/doan/frontend/sanpham/detail.php?sp_id=<?= $sanpham['sp_id'] ?>"><?= $sanpham['sp_ten'] ?></a></h6>
